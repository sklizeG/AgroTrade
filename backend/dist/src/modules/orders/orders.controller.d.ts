...
export declare class OrdersController {
    ...
    createOrder(user: AuthUser, dto: CreateOrderDto): Promise<{
        campaign: {
            farmer: {
                farmerProfile: {
                    id: string;
    ...
    getBuyerOrders(user: AuthUser): import("@prisma/client").Prisma.PrismaPromise<({
        campaign: {
            farmer: {
                farmerProfile: {
                    id: string;
    ...
    getFarmerOrders(user: AuthUser): import("@prisma/client").Prisma.PrismaPromise<({
        buyer: {
            buyerProfile: {
                id: string;
                createdAt: Date;
